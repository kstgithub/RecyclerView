...
public class ItemHeaderDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<CityCinema> mDatas;
    ...
    ItemHeaderDecoration(Context context, List<CityCinema> datas) {
        this.mDatas = datas;
    ...
    public ItemHeaderDecoration setData(List<CityCinema> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    private void drawHeader(RecyclerView parent, int pos, Canvas canvas) {
        View topTitleView = mInflater.inflate(R.layout.link_city_cinema_title_recycle_item, parent, false);
